      ...
      <AlertDialogContent>
        ...
        <div className="bg-gray-50 p-4 rounded-lg flex flex-col">
          ...
          <div className="w-full flex items-center justify-between gap-4 border-b border-b-muted py-3">
            ...
            <p className="text-xs font-medium capitalize text-muted-foreground">{dayjs(subscription.next_payment_date).format("MMMM Do, YYYY")}</p>
          </div>
        ...
        <p className="text-xs text-gray-700 my-4">
          ...
          <strong>{dayjs(subscription.next_payment_date).format("MMMM Do, YYYY")}</strong>.
        </p>
        </AlertDialogHeader>
