...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${type || "Houses & Apartments"} for Short Let in ${locationParts}`,
    description:
      "Find the best houses, flats, and apartments for short let in Nigeria. Browse verified listings across Lagos, Abuja, Port Harcourt, and more. Start your rental search today with RentCreeb.",
  };
}
