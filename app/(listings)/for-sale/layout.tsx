...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${type || "Houses & Apartments"} for Sale in ${locationParts}`,
    description:
      "Find the best houses, flats, and apartments for sale in Nigeria. Browse verified listings across Lagos, Abuja, Port Harcourt, and more. Start your rental search today with RentCreeb.",
  };
}
